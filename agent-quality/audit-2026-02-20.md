...
| **B** | 16 | genai-quality-monitor (47), webscraping-research-analyst (46), code-simplifier (45), content-creator (47), otel-session-summary (46), session-backlog (44), otel-quality-reporting (43), backlog-implementer (41), bug-detective (41), git-commit-smart (39), frontend-design (38), ralph-wiggum (37), cicd-cross-platform (36), html-auditor (22/30 A-eq), code-reviewer-skill (19.5/30 B-eq), code-explorer (19/30 B-eq), code-architect (19/30 B-eq) |
| **C** | 7 | agent-auditor (29), otel-improvement (35), codebase-analyzer (35), feature-dev (34), agent-improvement (33), otel-output-provenance (31) |
| **D** | 0 | -- |
